    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.FileField(blank=True, null=True, upload_to=instruments.models.get_upload_to_edm_photos, validators=[common_func.validators.validate_file_size], verbose_name='Instrument Photo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.FileField(blank=True, null=True, upload_to=instruments.models.get_upload_to_prism_photos, validators=[common_func.validators.validate_file_size], verbose_name='Instrument Photo')),
                ('comment', models.CharField(blank=True, max_length=265, null=True)),
                ('created_on', models.DateTimeField(auto_now_add=True, null=True)),
                ('modified_on', models.DateTimeField(auto_now=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.CharField(blank=True, max_length=265, null=True)),
                ('photo', models.FileField(blank=True, null=True, upload_to=instruments.models.get_upload_to_mets_photos, validators=[common_func.validators.validate_file_size], verbose_name='Instrument photo')),
                ('created_on', models.DateTimeField(auto_now_add=True, null=True)),
                ('modified_on', models.DateTimeField(auto_now=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('certificate_upload', models.FileField(blank=True, null=True, upload_to=instruments.models.get_upload_to_mets_certificate, validators=[common_func.validators.validate_file_size], verbose_name='Calibration Record')),
                ('created_on', models.DateTimeField(auto_now_add=True, null=True)),
                ('modified_on', models.DateTimeField(auto_now=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('certificate_upload', models.FileField(blank=True, null=True, upload_to=instruments.models.get_upload_to_edmi_certificate, validators=[common_func.validators.validate_file_size], verbose_name='Calibration Record')),
                ('created_on', models.DateTimeField(auto_now_add=True, null=True)),
                ('modified_on', models.DateTimeField(auto_now=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("source_ref", models.CharField(max_length=265)),

# Generated by Django 3.1 on 2022-07-04 00:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('edm_number', models.CharField(help_text='Enter the instrument serial number / unique ID', max_length=15)),
                ...
                ('edm_custodian', models.ForeignKey(blank=True, help_text='Name of instrument custodian', null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['edm_specs'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('inst_type', models.CharField(choices=[(None, 'Select one of the following'), ('edm', 'Total Station EDM'), ('prism', 'Prism'), ('level', 'Digital Level'), ('staff', 'Barcoded Staff'), ('baro', 'Barometer'), ('thermo', 'Themometer'), ('hygro', 'Hygrometer'), ('psy', 'Psychrometer'), ('others', 'Others')], max_length=6, null=True, verbose_name='instrument type')),
                ...
                ('make', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='instruments.instrumentmake')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prism_owner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='accounts.company')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('prism_number', models.CharField(help_text='Enter the instrument serial number / unique ID', max_length=15)),
                ('comment', models.CharField(blank=True, max_length=265, null=True)),
                ...
                ('created_on', models.DateTimeField(auto_now_add=True, null=True)),
                ('modified_on', models.DateTimeField(auto_now=True, null=True)),
                ('prism_custodian', models.ForeignKey(blank=True, help_text='Name of instrument custodian', null=True, on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
                ('prism_specs', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='instruments.prism_specification')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.CharField(blank=True, max_length=265, null=True)),
                ('photo', models.FileField(blank=True, null=True, upload_to='media/instrument_photos/mets/', verbose_name='Instrument photo')),
                ('created_on', models.DateTimeField(auto_now_add=True, null=True)),
                ('modified_on', models.DateTimeField(auto_now=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('zero_point_correction', models.FloatField(help_text='If: Correction to readins = Reading + 0.12°C, Zero point correction = 0.12', validators=[django.core.validators.MinValueValidator(-10.0), django.core.validators.MaxValueValidator(10.0)])),
                ...
                ('certificate_upload', models.FileField(blank=True, null=True, upload_to='media/calibration_certificates/', verbose_name='Calibration Record')),
                ('created_on', models.DateTimeField(auto_now_add=True, null=True)),
                ('modified_on', models.DateTimeField(auto_now=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('zpc_coverage_factor', models.FloatField(default=2.0, help_text='Coverage factor at 95% Confidence Level eg. 2.0', validators=[django.core.validators.MinValueValidator(1.0), django.core.validators.MaxValueValidator(5.0)], verbose_name='zero point correction coverage factor')),
                ('zpc_std_dev', models.FloatField(blank=True, help_text='Standard deviation of the zero point correction', null=True, validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(10.0)], verbose_name='Zero point correction standard deviation')),
                ('standard_deviation', models.FloatField(help_text='Results of measurement standard deviation (m)', validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(0.1)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('edm_type', models.CharField(choices=[('ph', 'Phase'), ('pu', 'Pulse')], default='ph', help_text='Instrument measurement type', max_length=2)),
                ...
                ('manu_unc_k', models.FloatField(default=2.0, help_text='Coverage factor at 95% Confidence Level eg. 2.0', validators=[django.core.validators.MinValueValidator(1.0), django.core.validators.MaxValueValidator(5.0)], verbose_name='manufacturers uncertainty coverage factor')),
                ('unit_length', models.FloatField(help_text='Unit Length (m)', validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(30.0)])),
                ...
                ('carrier_wavelength', models.FloatField(help_text='Carrier Wavelength (nm)', validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(1000)])),
                ...
                ('created_on', models.DateTimeField(auto_now_add=True, null=True)),
                ('modified_on', models.DateTimeField(auto_now=True, null=True)),
                ('edm_model', models.ForeignKey(limit_choices_to={'inst_type__exact': 'edm'}, on_delete=django.db.models.deletion.PROTECT, to='instruments.instrumentmodel')),
                ('edm_owner', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='accounts.company')),
            ],
            options={
                'ordering': ['edm_model'],
        ...
        migrations.AddField(
            model_name='edm_inst',
            name='edm_specs',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='instruments.edm_specification'),
        ),
        migrations.CreateModel(
            name='Staff',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('staff_number', models.CharField(help_text='Enter the instrument number', max_length=15, validators=[django.core.validators.MinLengthValidator(4)])),
                ...
                ('created_on', models.DateTimeField(auto_now_add=True, null=True)),
                ('modified_on', models.DateTimeField(auto_now=True, null=True)),
                ('staff_model', models.ForeignKey(blank=True, limit_choices_to={'inst_type__exact': 'staff'}, null=True, on_delete=django.db.models.deletion.CASCADE, to='instruments.instrumentmodel')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(auto_now_add=True, null=True)),
                ('modified_on', models.DateTimeField(auto_now=True, null=True)),
                ('level_model', models.ForeignKey(blank=True, limit_choices_to={'inst_type__exact': 'level'}, null=True, on_delete=django.db.models.deletion.CASCADE, to='instruments.instrumentmodel')),

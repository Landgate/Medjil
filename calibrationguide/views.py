...
def guide_create(request):
    ...
    return render(request, 'calibrationguide/calibrationguide_create.html', context)
...
def guide_update(request, id):
    ...
    return render(request, 'calibrationguide/calibrationguide_update.html', context) 

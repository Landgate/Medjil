    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field_file', models.FileField(blank=False, help_text='Upload the ASCII file generated by the level instrument', null=True, upload_to=staffcalibration.models.get_upload_to_fieldfile, validators=[common_func.validators.validate_file_size], verbose_name='Field Data')),
                ('field_book', models.FileField(blank=True, help_text='Upload the field book in pdf/jpg/tif format', null=True, upload_to=staffcalibration.models.get_upload_to_fieldbook, validators=[common_func.validators.validate_file_size], verbose_name='Field Book')),
                ...
                ('calibration_report', models.FileField(blank=True, help_text='Calibration report/certificate in pdf/jpg/tif format.', null=True, upload_to=staffcalibration.models.get_upload_to_calibreport, validators=[common_func.validators.validate_file_size], verbose_name='Calibration certificate')),

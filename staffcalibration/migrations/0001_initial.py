    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field_file', models.FileField(blank=False, help_text='Upload the staff reading from the level instrument in CSV format', null=True, max_length=1000, upload_to=staffcalibration.models.get_upload_to_fieldfile, validators=[common_func.validators.validate_file_size], verbose_name='Field Data')),
                ('field_book', models.FileField(blank=True, help_text='Upload the field book in pdf/jpg/tif format', null=True,max_length=1000, upload_to=staffcalibration.models.get_upload_to_fieldbook, validators=[common_func.validators.validate_file_size], verbose_name='Field Book')),

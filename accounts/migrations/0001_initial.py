    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('note_type', models.CharField(choices=[('M', 'Manditory'), ('C', 'Company Specific')], help_text='Will this note appear on all users reports or only reports for this company?', max_length=1)),

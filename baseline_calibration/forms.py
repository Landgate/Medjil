...
class PillarSurveyForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
           ...
           'thermometer2': forms.Select(attrs={'class': 'page1'}),
           'barometer': forms.Select(attrs={'class': 'page1'}),
           'barometer2': forms.Select(attrs={'class': 'page1'}),
           'hygrometer': forms.Select(attrs={'class': 'page1'}),
           'hygrometer2': forms.Select(attrs={'class': 'page1'}),
           ...
           'thermo2_calib_applied': forms.CheckboxInput(attrs={'class': 'page2'}),
           'baro_calib_applied': forms.CheckboxInput(attrs={'class': 'page2'}), 
           'baro2_calib_applied': forms.CheckboxInput(attrs={'class': 'page2'}), 
           'hygro_calib_applied': forms.CheckboxInput(attrs={'class': 'page2'}),
           'hygro2_calib_applied': forms.CheckboxInput(attrs={'class': 'page2'}),

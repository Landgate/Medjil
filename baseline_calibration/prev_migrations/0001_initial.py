# Generated by Django 3.1 on 2022-02-17 04:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='e.g., 1', max_length=25, verbose_name='pillar number')),
                ('order', models.CharField(blank=True, max_length=25, verbose_name='formatted name')),
                ('easting', models.DecimalField(decimal_places=3, help_text='MGA2020 Easting (m). eg., 395006.085', max_digits=9, validators=[django.core.validators.MinValueValidator(300000), django.core.validators.MaxValueValidator(900000)])),
                ('northing', models.DecimalField(decimal_places=3, help_text='MGA2020 Northing (m). eg., 6458541.334', max_digits=10, validators=[django.core.validators.MinValueValidator(3000000), django.core.validators.MaxValueValidator(10000000)])),
                ('zone', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(60)])),
                ('baseline', models.ForeignKey(limit_choices_to={'site_type__exact': 'baseline'}, on_delete=django.db.models.deletion.CASCADE, to='calibrationsites.calibrationsite', verbose_name='Site Name')),
            ],
            options={
                'ordering': ['baseline', 'order'],
                'unique_together': {('baseline', 'name')},
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('group', models.PositiveSmallIntegerField(choices=[(1, 'EDM scale factor'), (2, 'EDM scale factor (temp. effect)'), (3, 'EDM scale factor (drift over time)'), (4, 'EDM zero offset'), (5, 'Temperature unc'), (6, 'Pressure unc'), (7, 'Humidity unc'), (8, 'LS fit unc fixed term'), (9, 'LS fit unc proportional term'), (10, 'Centring'), (11, 'Heights'), (12, 'Offsets'), (13, 'Rounding')], help_text='Grouping of uncertainty source')),
                ('description', models.CharField(max_length=256)),
                ('units', models.CharField(blank=True, choices=[('mm', 'millimetres (mm)'), ('m', 'metres (m)'), ('°C', 'Degrees Celcius (°C)'), ('hPa', 'hectopascals (hPa)'), ('mmHg', 'Millimetre of mercury (mmHg)'), ('%', 'percent (%)')], help_text='Units of input quantity component', max_length=4, null=True)),
                ('ab_type', models.CharField(choices=[('A', 'A'), ('B', 'B')], help_text='Type A for a statistically derived component or Type B for any other derivation e.g. calibration report, manufacturers specification or an estimate based on experience.', max_length=1)),
                ('distribution', models.CharField(choices=[('N', 'Normal'), ('R', 'Rectangular')], help_text='A normal distribution represents most physical situations. Notable exceptions include rounding and resolution of a digital instrument. These components would typically be rectangular in distribution (equal probability anywhere within the estimated uncertainty range).', max_length=1)),
                ('x_value', models.FloatField(help_text='the raw input quantities (uncertainty components) in terms of the units specified')),
                ('x_value_k', models.FloatField(default=2.0, help_text='The coverage factor for each input quantity. Typically 2.0 for a 95% confidence interval (normal distribution) or sqrt(3) for a rectangular distribution. Use 1.0 if the input quantity is already expressed as a standard uncertainty.', validators=[django.core.validators.MinValueValidator(1.0), django.core.validators.MaxValueValidator(5.0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('std_uncertainty', models.FloatField(verbose_name='One Sigma Standard deviation of certified distance - Type A uncertianty only from LSA')),
                ...
                ('from_pillar', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='distance_standard_deviation_from_pillar', to='baseline_calibration.pillar')),
                ('to_pillar', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='distance_standard_deviation_to_pillar', to='baseline_calibration.pillar')),
            ],
        ),
        migrations.CreateModel(
            name='Pillar_Survey',
            fields=[
                ...
                ('mets_applied', models.BooleanField(default=True, help_text='Meterological corrections have been applied in the EDM instrument.')),
                ('edmi_calib_applied', models.BooleanField(default=False, help_text='The EDMI calibration correction has been applied prior to data import.')),
                ('staff_calib_applied', models.BooleanField(default=True, help_text='The staff calibration correction has been applied prior to data import.')),
                ('thermo_calib_applied', models.BooleanField(default=True, help_text='The thermometer calibration correction has been applied prior to data import.')),
                ('baro_calib_applied', models.BooleanField(default=True, help_text='The barometer calibration correction has been applied prior to data import.')),
                ('hygro_calib_applied', models.BooleanField(default=True, help_text='The hygrometer correction has been applied prior to data import.')),
                ...
                ('outlier_criterion', models.DecimalField(decimal_places=1, default=3, help_text='Number of standard deviations for outlier detection threashold.', max_digits=2, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(5)])),
                ...
                ('barometer', models.ForeignKey(help_text='Barometer used for survey', limit_choices_to={'mets_specs__make_model__inst_type': 'baro'}, on_delete=django.db.models.deletion.PROTECT, related_name='field_barometer', to='instruments.mets_inst')),
                ...
                ('hygrometer', models.ForeignKey(blank=True, help_text='Hygrometer, if used for survey', limit_choices_to={'mets_specs__make_model__inst_type': 'hygro'}, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='field_hygrometer', to='instruments.mets_inst')),
                ...
                ('psychrometer', models.ForeignKey(blank=True, help_text='Psychrometer, if used for survey', limit_choices_to={'mets_specs__make_model__inst_type': 'psy'}, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='field_psychrometer', to='instruments.mets_inst')),
                ...
                ('thermometer', models.ForeignKey(help_text='Thermometer used for survey', limit_choices_to={'mets_specs__make_model__inst_type': 'thermo'}, on_delete=django.db.models.deletion.PROTECT, related_name='field_thermometer', to='instruments.mets_inst')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_pillar', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='from_pillar', to='baseline_calibration.pillar')),
                ('pillar_survey', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='baseline_calibration.pillar_survey')),
                ('to_pillar', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='to_pillar', to='baseline_calibration.pillar')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='calibrated_baseline',
            name='pillar_survey',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='baseline_calibration.pillar_survey'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('baseline_pillar', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='baseline_calibration.pillar')),
                ('pillar_survey', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='baseline_calibration.pillar_survey')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_on', models.DateTimeField(auto_now=True, null=True)),
                ('calibrated_baseline', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='baseline_calibration.calibrated_baseline')),
                ('from_pillar', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='certified_distance_from_pillar', to='baseline_calibration.pillar')),
                ('to_pillar', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='certified_distance_to_pillar', to='baseline_calibration.pillar')),
            ],
            options={

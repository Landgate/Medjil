    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fieldnotes_upload', models.FileField(blank=True, null=True, max_length=1000, upload_to=baseline_calibration.models.Pillar_Survey.get_upload_to_location, validators=[common_func.validators.validate_file_size], verbose_name='Scanned fieldnotes')),

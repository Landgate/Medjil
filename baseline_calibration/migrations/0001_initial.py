    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('units', models.CharField(blank=True, choices=[('ppm', 'ppm'), ('%', '%'), ('1:x', 'Ratio (1:x)'), ('mm', 'mm'), ('m', 'm'), ('°C', '°C'), ('°F', '°F'), ('mBar', 'mBar'), ('hPa', 'hPa'), ('mmHg', 'mmHg')], help_text='Units of input quantity component', max_length=4, null=True)),

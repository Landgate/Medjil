    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('co2_content', models.FloatField(blank=True, default=420,help_text="Atmospheric CO2 content in ppm",null=True,verbose_name="Atmospheric CO2 content (ppm)")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('units', models.CharField(blank=True, choices=[('x:1', 'Scalar (x:1)'), ('ppm', 'ppm'), ('%', '%'), ('1:x', 'Ratio (1:x)'), ('mm', 'mm'), ('m', 'm'), ('°C', '°C'), ('°F', '°F'), ('mBar', 'mBar'), ('hPa', 'hPa'), ('mmHg', 'mmHg')], help_text='Units of input quantity component', max_length=4, null=True)),

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site_access', models.FileField(help_text='Upload a pdf diagram showing an access to the location', null=True, max_length=1000, upload_to=calibrationsites.models.get_upload_to_location, validators=[common_func.validators.validate_file_size], verbose_name='Access Summary')),
                ('site_config', models.FileField(help_text='Upload a pdf diagram showing the location of pins or pillars', null=True, max_length=1000, upload_to=calibrationsites.models.get_upload_to_location, validators=[common_func.validators.validate_file_size], verbose_name='Site Configuration')),

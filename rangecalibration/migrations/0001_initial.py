    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('calibration_report', models.FileField(blank=True, null=True, upload_to=rangecalibration.models.get_upload_to_calibreport, validators=[common_func.validators.validate_file_size], verbose_name='Calibration Certificate/Report')),
                ('field_file', models.FileField(help_text='Upload the ASCII file generated by the level instrument', null=True, upload_to=rangecalibration.models.get_upload_to_fieldfile, validators=[common_func.validators.validate_file_size], verbose_name='Field Data')),
                ('field_book', models.FileField(help_text='Upload the field book in pdf/jpg/tif format', null=True, upload_to=rangecalibration.models.get_upload_to_fieldbook, validators=[common_func.validators.validate_file_size], verbose_name='Field Book')),
